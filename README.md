...
위 Step 1, Step 2 절차가 통합된 `shell script 파일`을 제공하고 있으므로 해당 파일을 다운로드 받아 설치

> curl -fsSL https://get.docker.com -o get-docker.sh    
> sh get-docker.sh

```sh
your-terminal> curl -fsSL https://get.docker.com -o get-docker.sh
your-terminal> ls
get-docker.sh
your-terminal> sh get-docker.sh
